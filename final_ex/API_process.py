...
colors = [[20, 111, 93], [110, 115, 20], [32, 7, 21], [52, 44, 98], [119, 21, 39], [17, 76, 78], [53, 89, 55],
          [23, 28, 6], [30, 94, 29], [92, 26, 8], [52, 91, 13], [29, 4, 76], [64, 3, 107], [112, 15, 118], [29, 22, 13],
          [77, 11, 5], [7, 31, 73], [4, 13, 92], [110, 100, 9], [4, 3, 46]]
index = 0
# 加载保存的相机矩阵和畸变系数
...
def run(img):
    img = main(img)
    img_min = cv2.resize(img, dsize=None, fx=0.2, fy=0.2, interpolation=cv2.INTER_LINEAR)  # 图像过大就缩小了再处理
    return img, img_min
